package com.cyt.lib_audio.mediaPlayer.view;
...
import com.cyt.lib_audio.mediaPlayer.events.AudioProgressEvent;
...
public class MusicPlayerActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        ImageLoaderManger.getInstance().displayImageForViewGroup(mBgView, mAudioBean.albumPic);
